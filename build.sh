...
/opt/android-sdk-mac_x86/build-tools/29.0.2/apksigner sign --ks app/keystore --ks-key-alias "tecarta apps" --ks-pass pass:Secur1ty --key-pass pass:Secur1ty ${HTDOCS}/bibles/android/BibleSearch-${BUILD_ID}-${BUILD_NUMBER}.apk
